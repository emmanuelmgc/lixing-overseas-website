...
export default function CasesPage() {
  return (
    <>
      <HeroSection compact eyebrow="Cases" title="看见真实问题、动作和阶段性结果" subtitle="敏感项目默认匿名呈现，不展示客户 Logo 墙，只展示客户问题、励行动作和当前结果。" image="/images/lixing/ppt-boardroom-dialogue.webp" primary="聊聊你的出海问题" />
